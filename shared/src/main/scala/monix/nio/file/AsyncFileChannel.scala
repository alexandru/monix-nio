...
import monix.nio.file.internals.{ AsyncFileChannelBuilders, AsyncFileChannelBuildersImpl }
...
object AsyncFileChannel extends AsyncFileChannelBuildersImpl
  with AsyncFileChannelBuilders